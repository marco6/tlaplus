...
public class PlusCalParserOutputTranslator {
	...
	private static class PcalStart {
		 ...
		 * @throws IllegalArgumentException If the text does not contain a PlusCal
		 *                                  block.
		 */
	...
	public static AST parse(String input) throws ParseAlgorithmException {
		...
		PcalCharReader reader = new PcalCharReader(new Vector<String>(lines), start.line, start.column, endLine,
				(int) endColumn);
