...
public class TLCTest {
	...
	public void testHandleParametersAbsoluteInvalid() {
		...
		assertFalse(
				tlc.handleParameters(new String[] { "-fpmem", "-1", TLAConstants.Files.MODEL_CHECK_FILE_BASENAME }));
	}
	...
	public void testHandleParametersAbsoluteValid() {
		final TLC tlc = new TLC();
		assertTrue(
				tlc.handleParameters(new String[] { "-fpmem", "101", TLAConstants.Files.MODEL_CHECK_FILE_BASENAME }));
	}
	...
	public void testHandleParametersFractionInvalid() {
		final TLC tlc = new TLC();
		assertFalse(
				tlc.handleParameters(new String[] { "-fpmem", "-0.5", TLAConstants.Files.MODEL_CHECK_FILE_BASENAME }));
	}
	...
	public void testHandleParametersAllocate90() {
		final TLC tlc = new TLC();
		assertTrue(
				tlc.handleParameters(new String[] { "-fpmem", ".99", TLAConstants.Files.MODEL_CHECK_FILE_BASENAME }));
	...
	public void testHandleParametersMaxSetSize() {
		...
		TLC tlc = new TLC();
		assertFalse(tlc
				.handleParameters(new String[] { "-maxSetSize", "NaN", TLAConstants.Files.MODEL_CHECK_FILE_BASENAME }));

		tlc = new TLC();
		assertFalse(tlc
				.handleParameters(new String[] { "-maxSetSize", "0", TLAConstants.Files.MODEL_CHECK_FILE_BASENAME }));
		tlc = new TLC();
		assertFalse(tlc
				.handleParameters(new String[] { "-maxSetSize", "-1", TLAConstants.Files.MODEL_CHECK_FILE_BASENAME }));
		tlc = new TLC();
		...
		assertTrue(tlc.handleParameters(
				new String[] { "-maxSetSize", Integer.toString(progDefault),
						TLAConstants.Files.MODEL_CHECK_FILE_BASENAME }));
	...
	public void testHandleParametersSimulateFileNum() {
		TLC tlc = new TLC();
		assertTrue(tlc.handleParameters(
				new String[] { TLAConstants.Files.MODEL_CHECK_FILE_BASENAME, "-simulate", "num=5,file=test.txt" }));
		tlc = new TLC();
		assertFalse(tlc.handleParameters(
				new String[] { TLAConstants.Files.MODEL_CHECK_FILE_BASENAME, "-simulate", "file=test.txt" }));
		tlc = new TLC();
		assertTrue(tlc.handleParameters(
				new String[] { TLAConstants.Files.MODEL_CHECK_FILE_BASENAME, "-simulate", "num=10" }));
	}
