...
public class CommentsTest {
        ...
        public void variablesWithInlineComments() {
                // This tests that inline comments on multi-line VARIABLES declarations are
                // preserved.
                // In SANY's AST, inline comments after a token are stored as pre-comments of
                // the NEXT token.
                // So "clock, \* local clock" has the comment stored as pre-comment of "req".
                // The trailing comment after the last variable is attached to the next
                // declaration.
                var input = "---------- MODULE Test -----\n" +
                                ...
                                "Init == TRUE\n" +
                                "====";
                // The formatted output preserves comments, but trailing comment moves to next
                // line
        ...
        public void variablesWithMultiLineBlockComments() {
                ...
                // are preserved correctly, not joined on a single line with commas between
                // them.
                // This is a bug that was causing parse errors in
                // specifications/Prisoners/Prisoners.tla
                var input = "---------- MODULE Test -----\n" +
                                "VARIABLES\n" +
                                "  switchAUp,\n" +
                                "  switchBUp,\n" +
        ...
        public void constantsWithInlineComments() {
                // This tests that inline comments on multi-line CONSTANT declarations are
                // preserved.
                // Similar to VARIABLES, SANY stores inline comments as pre-comments of the NEXT
                // token.
                var input = "---------- MODULE Test -----\n" +
                                ...
                                "Init == TRUE\n" +
                                "====";
                // The formatted output preserves comments. The trailing comment moves to the
                // next line.
                var expected = "---------- MODULE Test -----\n" +
                                "CONSTANT Jug,    \\* The set of all jugs.\n" +
                                "         Capacity,    \\* Capacity of each jug.\n" +
        ...
        public void localInstanceWithBlockComment() {
                // This tests that block comments before LOCAL INSTANCE declarations are
                // preserved.
                var input = "---------- MODULE Test -----\n" +
                                "(* Block comment *)\n" +
        ...
        public void constantsWithCommaFirstComments() {
                ...
                // on the comma node (not the next constant). Comma-first formatting is
                // preserved
        ...
        public void recordConstructorWithCommentOnComma() throws Exception {
                // Comments attached to comma separators in record constructors should be
                // preserved.
                // In comma-first style, SANY attaches the comment to the comma node as a
                // preComment.
                var input = "---- MODULE Test ----\n" +
                                "Foo == [ a |-> 1\n" +
                                "  \\* comment on comma\n" +
        ...
        public void infixConjunctionWithComments() throws Exception {
                // When conjunction /\ items are NOT aligned at the same column, SANY parses
                // them
                // as infix operators (N_InfixExpr) rather than a bulleted list (N_ConjList).
                // Comments on infix /\ operators are attached to the inner INFIX_OP token
                // (kind=373)
        ...
        public void recordConstructorBracketWithPreComment() throws Exception {
                // When a comment appears between { and [ in a set containing a record
                // constructor,
