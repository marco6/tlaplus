    ...
    for (int k = 0; k < toks.length; k++) {
      ...
      while (i < input.length) {
        if ((i < input.length - 2)
            ...
            && (input[i + 2].column == input[i + 1].column + input[i + 1].getWidth())) {
          int numOfToks = 3;
          ...
          if ((i < input.length - 3)
            ...
            numOfToks = 4;
            if ((i < input.length - 4)
                && (input[i + 4].column == input[i + 3].column + input[i + 3].getWidth())
          ...
          if ((i < input.length - numOfToks)
              ...
              && ((BuiltInSymbols.GetBuiltInSymbol(
                  input[i + numOfToks].string, true).symbolType == Symbol.INFIX)
                  || (BuiltInSymbols.GetBuiltInSymbol(
                      input[i + numOfToks].string, true).symbolType == Symbol.PUNCTUATION))) {
            needsSpace = false;
          }
          ;
          outputVec.addElement(new Token.PfStepToken(str,
              input[i].column,
              needsSpace));
          i = i + numOfToks;
        } // if
