...
public class FindAlignments {
        ...
        if (!token.subscript) {
          ...
          if (isRightComment(spec, pos)) { /***********************************************************
            ...
            if ((ctok.subtype == CommentToken.MULTI)
               ...
               ********************************************************/
              if (((CommentToken) btoken).subtype == CommentToken.BEGIN_MULTI) {
              ...
              if ((bpos.line != -1)
                ...
                if ((item == 0)
                  ...
                  pos.toToken(spec).aboveAlign = coveringPosition(spec, pos, true);
                }
                ;
              }
              ...
              if (((item == 0) && (token.type != Token.COMMENT))
                  || ((item == 1)
                      && (spec[line][0].type == Token.COMMENT))) { /*****************************************************
                                                                    ...
                                                                    *****************************************************/
                token.aboveAlign = coveringPosition(spec, pos, true);
              } else {
                /*****************************************************
                ...
                if (isLeftComment(spec, pos)) {
                  token.aboveAlign = coveringPosition(spec, pos, false);
                } else { /*************************************************
                  ...
                  if (token.type == Token.BUILTIN) {
                    alignClass = BuiltInSymbols.GetBuiltInSymbol(
                        token.string, true).alignmentType;
                  }
                  ;
                  if ((ctoken != null)
                      && (ctoken.type == Token.BUILTIN)) {
                    calignClass = BuiltInSymbols.GetBuiltInSymbol(
                  ...
                  if ((ctoken != null)
                    ...
                    if (((item == 1)
                        ...
                        && (BuiltInSymbols.GetBuiltInSymbol(
                            spec[line][item - 1].string, true).symbolType == Symbol.INFIX)
                        /******************************************
                        ...
                        && (ctoken != null)
                        && (token.column == ctoken.column)
                        && (spec[line][item - 1].aboveAlign.line != -1)) { /*******************************************
                      ...
                      if ((alPos.line == cpos.line)
                        ...
                        if ((cpos.item == 0)
                            || ((cpos.item == 1)
                                && (spec[cpos.line][0].type == Token.COMMENT))) { /*****************************************
                                                                                   * InfixArg alignment with a token *
    ...
    while (line < spec.length) {
      ...
      while (item < spec[line].length) {
        ...
        if (token.aboveAlign.line != -1) {
           ...
           ********************************************************/
          {
            token.aboveAlign.toToken(spec).isAlignmentPoint = true;
          }
          ;
        }
        ;
        ...
        if (token.belowAlign.line != -1) {
          ...
          if (token.belowAlign.line != 0) {
            token.belowAlign.toToken(spec).isAlignmentPoint = true;
          }
          ;
        }
        ;
   ...
   * label: stmt
   * 
   * the first stmt's aboveAlign field should point to x by the
   * FirstNonLeftComment
   * alignment rule. For
   * 
   * while x
      ...
      while (item < spec[line].length) {
        ...
        if (startSub == -1) {
          ...
          if ((tok.type == Token.BUILTIN)
              && ((BuiltInSymbols.GetBuiltInSymbol(
                  tok.string, true).symbolType == Symbol.SUBSCRIPTED)
                  || (tok.string.equals("^")))) {
            startSub = item + 1;
          ...
          if (tok.type == Token.BUILTIN) {
            symType = BuiltInSymbols.GetBuiltInSymbol(
