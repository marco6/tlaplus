...
public final class Misc {
   ...
   *************************************************************************/
  {
    ...
    while ((!done)
        && (restOfString
            .length() > Parameters.MaxOutputLineLength)) { /********************************************************************
                                                            * If there is a space char in the line, set lastSpace to the
                                                            * index *
                                                            * of the char at which to break the line: either the last
                                                            * space *
                                                            * char before index MaxOutputLineLength, or the first one
                                                            * after *
                                                            * it. If there is no space char in the line, set lastSpace
                                                            * to -1. *
                                                            ********************************************************************/
      ...
      if (lastSpace <= Parameters.MaxOutputLineLength / 4) {
                ...
                *****************************************************************/
        cut = true;
        String outputLine = EliminateLeadingBlanks(restOfString.substring(0, lastSpace));
