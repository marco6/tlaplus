 ...
 * <br>
 * This class is used for typed model values. To create an instance of this
 * class
 * you probably want to parse it out of a string, using
 * {@link TypedSet#parseSet(String)} method.
 * 
 * A TypedSet object appears to be used to represent a TLA+ set of the form
 * 
 * { a1 , a2, ... , aN }
 * 
 * for N >= 0, where each ai is a TLA+ identifier. If each of the ai begins with
 * "C_"
 * for the same character C, then it is represented by an object having type =
 * "C_" and
 * values[i] equal to ai with the prefix "C_" removed, for each i. Otherwise, it
 * is represented
...
public class TypedSet {
     ...
     * 
     * @param index, index of the value, should be smaller then the value of
     *               {@link TypedSet#getValueCount()}
     ...
     * Is used to be set in the right side of assignment
     * ({@link Assignment#setRight(String)})
     * <br>
     * <b>Note:</b> {@link TypedSet#toString()} should not be used for comparison
     * 
