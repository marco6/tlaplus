...
// SZ Jul 13, 2009: there is no reason to extend the RMI interfaces, since they
// are not used
// extends UnicastRemoteObject implements FPIntSetRMI
{
  ...
  protected FPIntSet() throws RemoteException {
    /* SKIP */ }
   ...
   * 
   * An instance of FPIntSet is hold by every worker. In addition, a "global"
   * FPIntSet is used in the ModelChecker.
   * The static fields are used to compare the "global" value with the instance
   * values of the worker instances.
   * This is a very fishy, and should be changed to the following: static
   * modifiers should be removed and replaced by explicit
