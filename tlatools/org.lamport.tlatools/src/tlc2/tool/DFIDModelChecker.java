    ...
    public final boolean doNext(final ITool tool, TLCState curState, long cfp, boolean isLeaf, StateVec states,
        ...
        try {
            ...
            for (int i = 0; i < tool.getActions().length; i++) {
                ...
                for (int j = 0; j < sz; j++) {
                    ...
                    if (inModel) {
                        ...
                        this.allStateWriter.writeState(curState, succState,
                                status == FPIntSet.NEW ? IStateWriter.IsUnseen : IStateWriter.IsSeen);
            ...
            if (this.checkLiveness && isLeaf) {
                ...
                this.allStateWriter.writeState(curState, curState, IStateWriter.IsUnseen,
