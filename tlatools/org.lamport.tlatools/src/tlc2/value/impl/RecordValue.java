  ...
  public final Value normalize() {
    try {
      if (!this.isNorm) {
        ...
        it.unimi.dsi.fastutil.Arrays.quickSort(0, this.names.length,
            (a, b) -> this.names[a].compareTo(this.names[b]),
            (arg0, arg1) -> {
              UniqueString tempStr = this.names[arg0];
              this.names[arg0] = this.names[arg1];
              this.names[arg1] = tempStr;

              Value tempVal = this.values[arg0];
