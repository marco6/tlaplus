 ...
 *
 * <p>
 * Operators are not really values in TLA+, but TLC needs to be able to
 * represent operators
 * to support operators that take higher-order operators as arguments. To give
 * an artificial
 * example:
 *
 * <pre>
 ...
 * </pre>
 *
 * The argument <code>Eq</code> will be represented as an <code>OpValue</code>
 * when TLC evaluates
...
public abstract class OpValue extends Value {
     ...
     *
     * <p>
     * Implementations will typically begin by evaluating each of the given
     * <code>args</code>,
     * but that is not a firm requirement. For instance, an implementation may
     ...
     * @param s1      the next state (null when evaluating invariants or the initial
     *                predicate)
