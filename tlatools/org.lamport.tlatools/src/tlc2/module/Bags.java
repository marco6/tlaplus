...
public class Bags implements ValueConstants {
    ...
    public static IBoolValue IsABag(final Value b) {
        ...
        if (fcn == null) {
            // MAK 02/23/2018 Changed to return ValFalse instead of exception when Value is
            // not a bag.
            // throw new EvalException(EC.TLC_MODULE_APPLYING_TO_WRONG_VALUE, new String[] {
            // "IsBag",
            ...
            if (vals[i] instanceof IntValue) {
                ...
                if (cnt > 0) {
                    ...
                    throw new EvalException(EC.TLC_MODULE_APPLYING_TO_WRONG_VALUE,
                            new String[] { "BagCardinality", "a bag",
    ...
    public static Value SetToBag(Value b) {
        ...
        // The following `if' added by LL on 5 Mar 2012 to correct a bug found by Tom
        // Rodeheffer,
        // in which SetToBag creates a function with multiple copies of the elements in
        // its
