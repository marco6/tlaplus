...
public class ByteUtils {
   ...
   * is the size of byte[]
   */
  public static void writeSizeArrayOfSizeBigInts(BigInt[] A, int start, int finish, OutputStream out)
      throws IOException {
   ...
   */
  public static void writeArrayOfSizeBigInts(BigInt[] A, int start, int finish, OutputStream out)
      throws IOException {
