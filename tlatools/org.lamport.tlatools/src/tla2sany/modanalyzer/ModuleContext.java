...
/**
 * An instance of this class is the ModuleContext for a module, i.e. the mapping
 * between
 * module String names and other ModulePointers elsewhere in the specification
 * that they
 * are bound to.
 * 
 * There is no distinction made between a String that is not the name of a
 * module known
 * in this context, and an as-yet unbound name that is known. In both cases
 * resolve()
 * returns null.
 */
