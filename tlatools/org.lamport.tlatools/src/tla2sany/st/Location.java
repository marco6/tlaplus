 ...
 * A location is immutable and consists of beginning and ending line and column
 * numbers
...
public final class Location implements Comparable<Location> {
    ...
    private static final String OPEN_ACTION = "<[A-Za-z_0-9]+ "; // The regex used to just be "Action" but the most
                                                                 // recent TLC prints the name of the action instead of
                                                                 // just the location.
    ...
    public static final Pattern LOCATION_MATCHER = Pattern
            ...
            /* bc group */ + TO_LINE + NATURAL /* el group */ + COL + NATURAL /* ec group */ + OF_MODULE
    ...
    public static final Pattern LOCATION_MATCHER3 = Pattern.compile(OPEN_ACTION + LINE + NATURAL /* bl group */ + COL
            + NATURAL
            /* bc group */ + TO_LINE + NATURAL /* el group */ + COL + NATURAL /* ec group */ + OF_MODULE + MODULE_ID /*
                                                                                                                      * module
                                                                                                                      * group
                                                                                                                      */
            + CLOSE_ACTION);
    ...
    /**
     * A pattern to match locations when there is an error evaluating a nested
     * expression.
     */
    public static final Pattern LOCATION_MATCHER4 = Pattern
            .compile(LINE_CAP + NATURAL /* bl group */ + COLUMN + NATURAL
            /* bc group */ + TO_LINE + NATURAL /* el group */ + COLUMN + NATURAL /* ec group */ + IN + MODULE_ID /*
                                                                                                                  * module
                                                                                                                  * group
                                                                                                                  */);
    ...
    /**
     * @param coordinates
     *                    An int array of size 4 with 0-based coordinates:
     *                    0=beginLine,
     ...
     * 
     * @param locationString the string representation produced by
     *                       {@link Location#toString()} method
     * @return location if it could be parsed, or a {@link Location#nullLoc}
     *         otherwise
     */
