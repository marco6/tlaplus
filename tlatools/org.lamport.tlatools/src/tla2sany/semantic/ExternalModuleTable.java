...
public class ExternalModuleTable implements ExploreNode {
  ...
  public class ExternalModuleTableEntry implements ExploreNode {
    ...
    Context ctxt; // and its full context, including all Builtin ops, ops from EXTENDS and
                  // INSTANCE,
    ...
    /**
     * walkGraph, levelDataToString, and toString methods to implement ExploreNode
     * interface
     */
    ...
    public void walkGraph(Hashtable<Integer, ExploreNode> moduleNodesTable, ExplorerVisitor visitor) {
      ...
      if (ctxt != null)
        ctxt.walkGraph(moduleNodesTable, visitor);
    } // end walkGraph()
