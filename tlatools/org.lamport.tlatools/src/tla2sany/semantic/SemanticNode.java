...
public abstract class SemanticNode
    implements ASTConstants, ExploreNode, LevelConstants, Comparable<SemanticNode>, XMLExportable /*
                                                                                                   * interface for
                                                                                                   * exporting into XML
                                                                                                   */ {
   ...
   *
   * @param location                  Find a node in this subtree matching this
   *                                  location.
   * @param requireExactLocationMatch If true, only returns the path if a
   *                                  node spans the exact given location; if
   *                                  false allow paths
   *                                  starting from a leaf node that completely
   *                                  encompasses the
   *                                  given location.
  ...
  /**
   * August 2014 - TL
   * All nodes inherit from semantic node, which just attach location to the
   * returned node
   */
