...
public class SymbolTable implements ASTConstants {
  ...
  public final boolean addSymbol(UniqueString name, SymbolNode symbol) {
    ...
    // If the symbol being redefined is a built-in symbol, this is definitely an
    // error
    ...
    // The following test is misguided. The problem we need to worry about is
    // merging symbols
    // from the same module twice or more through EXTENDS or INSTANCE. Not multiple
    // definitions.
