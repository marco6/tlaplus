...
public class Operators {
   ...
   */
  private static final Hashtable<UniqueString, Operator> DefinitionTable = new Hashtable<UniqueString, Operator>();
  ...
  public static void printTable() {
    ...
    while (Enum.hasMoreElements()) {
      System.out.println("-> " + ((UniqueString) Enum.nextElement()).toString());
    }
  }
