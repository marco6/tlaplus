...
public interface XMLExportable {
  ...
  /**
   * an object extending this interface is exported into an XML element using
   * these two methods.
   * These are wrapper methods calling the getElement in order to generate the
   * actual element
   * and wrapping it inside general information such as location, which is common
   * to all elements
   * 
