...
/**
 * Converts abstract filenames (e.g. <code>"Integers.tla"</code>) to concrete
 * locations
 * (e.g.
 * <code>"jar:file:/path/to/tla2tools.jar!/tla2sany/StandardModules/Integers.tla"</code>).
 *
 * <p>
 * This interface is simple enough to be composable: multiple locators can be
 * chained together
...
interface ResourceLocator {
    ...
    /**
     * Locate the given file. The name is treated as a filename, not a TLA+ module
     * name;
    ...
    /**
     * Get a human-readable string describing the locations that
     * {@link #locate(String)} will search.
     *
