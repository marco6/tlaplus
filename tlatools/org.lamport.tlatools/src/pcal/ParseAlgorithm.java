...
public class ParseAlgorithm {
   ...
   * process in
   * a multiprocess algorithm. This procedure sets omitPC or
  ...
  public static TLAExpr GetExpr() throws ParseAlgorithmException {
    ...
    if (result.tokens != null && result.tokens.size() != 0) {
      PCalLocation begin = ((TLAToken) ((Vector) result.tokens.elementAt(0))
   ...
   ********************************************************************/
  {
    ...
    while (i < stmtseq.size()) {
      ...
      ;
      if (stmt.getClass()
          .equals(AST.LabelIfObj.getClass())) { /************************************************************
        ...
        nextStepNeedsLabel = InnerAddLabels(obj.unlabThen,
            false, // firstLabeled
            inWith, // inWith
            outAssigned, // inAssigned = {}
            thenAssigned); // outAssigned
        nextStepNeedsLabel = InnerAddLabels(obj.unlabElse,
            false, // firstLabeled
            inWith, // inWith
            outAssigned, // inAssigned = {}
        ...
        // PcalDebug.printVector(outAssigned, "pst outAssigned") ;
          ...
          .equals(AST.LabelEitherObj.getClass())) { /************************************************************
        ...
        while (j < obj.clauses.size()) {
          ...
          nextStepNeedsLabel = InnerAddLabels(clause.unlabOr,
              false, // firstLabeled
              inWith, // inWith
              outAssigned, // inAssigned = {}
        ...
        ;
        Vector newOutAssigned = new Vector();
        nextStepNeedsLabel = InnerAddLabels(obj.Do,
            false, // firstLabeled
            true, // inWith
        ...
        if (result < 2) {
          ...
          while (j < eitherNode.clauses.size()) {
            newEither.ors.addElement(
                ((AST.Clause) eitherNode.clauses.elementAt(j)).unlabOr);
            j = j + 1;
          }
          ;
    ...
    while (i < stmtseq.size()) {
      ...
      if (node.getClass().equals(
        ...
        ExpandMacrosInStmtSeq(((AST.While) node).unlabDo, macros);
          ...
          AST.MacroCallObj.getClass())) {
        Vector expansion = ExpandMacroCall(((AST.MacroCall) node), macros);
  ...
  public static Vector ExpandMacroCall(AST.MacroCall call, Vector macros) throws ParseAlgorithmException { // Set
                                                                                                           // macroDef
                                                                                                           // to the
                                                                                                           // Macro
                                                                                                           // object
   ...
   *********************************************************************/
  {
    ...
    try {
      ...
      if (stmt.getClass().equals(AST.WhileObj.getClass())) {
        ...
        result.test = tstmt.test.cloneAndNormalize();
        result.test.substituteForAll(args, params);
        result.unlabDo = SubstituteInStmtSeq(tstmt.unlabDo,
            args,
            params,
            macroLine,
            macroCol);
        result.labDo = SubstituteInLabeledStmtSeq(tstmt.labDo,
            args,
            params);
      ...
      if (stmt.getClass().equals(AST.LabelIfObj.getClass())) {
        ...
        result.test = tstmt.test.cloneAndNormalize();
        result.test.substituteForAll(args, params);
        result.unlabThen = SubstituteInStmtSeq(tstmt.unlabThen,
            args,
            params,
            macroLine,
            macroCol);
        result.labThen = SubstituteInLabeledStmtSeq(tstmt.labThen,
            args,
            params);
        result.unlabElse = SubstituteInStmtSeq(tstmt.unlabElse,
            args,
            params,
            macroLine,
            macroCol);
        result.labElse = SubstituteInLabeledStmtSeq(tstmt.labElse,
            args,
            params);
